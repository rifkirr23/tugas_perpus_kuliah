  ...
  <div class="row">
    <div class="login-box">
      <div class="login-logo">
       <h1 style="color:#fff;">Perpus Login</h1>
      </div>
   <!-- /.login-logo -->
   <div class="login-box-body">
   	 <p style="margin-top:20px;" class="text-center"><img src="<?php echo base_url('assets/logo2.jpg'); ?>" alt="" style="width:290px;height:160px;"></p>
