...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-133151863-4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-133151863-4');
</script>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
    <title>Jasa Kargo Cina Termurah & Terpercaya</title>
...
<body>
    ...
    <section class="section-hero">
        <div class="container">
            ...
            </div><a class="link-cta" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
    </section>
    <!-- End: Section 1 -->
    <!-- Start: section 2 -->
    <section class="text-center section-default bg-gradient">
        <div class="container mt-5">
            ...
            <div class="text-center flow-gambar"><img src="assets/img/flow-gambar_1.png"></div><a class="link-cta" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div><img class="bg-over" src="assets/img/city.svg"></section>
    <!-- End: section 2 -->
    <!-- Start: Section FAQ -->
        ...
        <div class="carousel-item active">
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <p>Kami menyediakan jasa titip transfer RMB ke rekening bank supplier di Cina. Anda dapat bayar kepada kami dalam Rupiah, tidak perlu repot lagi!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <p>Benar sekali! Ternyata impor dari China itu sangat mudah jika menggunakan jasa kami! Anda TIDAK PERLU memiliki PT, tidak perlu mengurus ekspor dan impor, pemesanan kapal, pengurusan dokumen dan legalitas, pengurusan ijin impor, pembayaran
                        ...
                        Anda datang sampai di depan rumah Anda!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <p>Proses impor lewat laut sekitar 3-5 minggu, dan impor lewat udara 5-7 hari!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <a
                        class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="row">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <p>Jangan khawatir, ongkos kirim barang Anda dibayarkan ketika barang sampai di gudang Jakarta. Transaksi dan barang Anda pasti aman bersama kami. Kami adalah perusahaan berbadan hukum legal yang resmi terdaftar. Anda juga dapat datang
                        ke kantor kami agar lebih percaya :)<br /></p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <p>Benar sekali! Ternyata impor dari China itu sangat mudah jika menggunakan jasa kami! Anda TIDAK PERLU memiliki PT, tidak perlu mengurus ekspor dan impor, pemesanan kapal, pengurusan dokumen dan legalitas, pengurusan ijin
                                    ...
                                    duduk manis menunggu barang Anda datang sampai di depan rumah Anda!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <p>Barang yang hilang karena musibah tak terduga seperti kapal terbakar, kapal jatuh, force major, mobil dicuri, dan lain-lain&nbsp;yang menyebabkan barang tidak sampai, akan kami cover garansi uang kembali sesuai nilai barang
                                    anda!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <p>Jangan khawatir, ongkos kirim barang Anda dibayarkan ketika barang sampai di gudang Jakarta. Transaksi dan barang Anda pasti aman bersama kami. Kami adalah perusahaan berbadan hukum legal yang resmi terdaftar. Anda juga
                                    dapat datang ke kantor kami agar lebih percaya :)<br></p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
                        </div>
                    </div>
                </div>
                <div>
    ...
    <section class="section-testimoni gradien-testi">
        <div class="container">
            ...
            <div class="text-center p-3"><a class="link-cta fill" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
        </div>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 col-xl-8">
                    <div class="text-promo">
                        ...
                        <p>Untuk customer yang daftar di Bulan September akan mendapatkan harga special! Hanya bulan ini!</p><a class="link-cta sm" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-pricelist gradien-pricelist">
        <div class="container">
            ...
            <div class="text-white p-3 text-center">
                <p>*Pengiriman barang diatas 10 CBM / BULAN, akan kami potong lagi 500 RB / CBM<br></p><a class="link-cta fill" href="https://wilopocargo.com/mulaisekarang?utm_source=dm&utm_source=dm&utm_medium=landingpage2&utm_campaign=mulaisekarangbutton#contactus">Mulai Sekarang Gratis</a></div>
        </div>
    </section>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-6 col-xl-6">
                    ...
                    <form class="form-contact" action="backend/daftar.php" method="post">
                        ...
                        <div><button class="btn btn-danger border-50" type="submit">Mulai Sekarang Gratis</button></div>
                    </form>
                </div>
            </div>
        </div>
    ...
    <!-- End: Section Contact -->
    <a class="float-whatsapp" id="wastickyajax" href="https://api.whatsapp.com/send?phone=6281310085523&text=Halo,%20saya%20ingin%20bertanya%20kepada%20cs%20Wilopo%20Cargo.....%20"><i class="fab fa-whatsapp"></i><div class="tcl"><p>Ada yang ditanyakan?<br>Yuk chat dengan kami.</p></div></a>
