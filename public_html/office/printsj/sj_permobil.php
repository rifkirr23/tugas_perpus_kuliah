...
// print_r($row_surat_jalan_detail);die();
  ...
  while ($row_surat_jalan_list = $sql_surat_jalan_list->fetch_array()) {
      ...
      //Volume
      @$sp = 21-strlen($row_surat_jalan_list['volume']*$row_surat_jalan_list['jumlah']);
