...
<?php if($this->session->flashdata('msg')=='oksave'){ ?>
 ...
 <p><div style="display: none;" class="alert alert-info alert-dismissable"><i class="icon fa fa-check"></i>Berhasil Menandai
...
<div class="row">
  <div class="box box-primary">
    <form class="" action="<?php echo site_url() ?>admin/customer/save_nosk" method="post">
      <div class="box-header with-border">
        <h3 class="box-title"><b>Customer No SK</b></h3>
        <span class="pull-right">
             <button class="btn btn-warning" type="submit"><i class="fa fa-paper-plane"> Save SK </i></button>
        </span>
        <span class="pull-right" style="margin-right:5px;"></span>
      </div>
      <div class="box-body">
