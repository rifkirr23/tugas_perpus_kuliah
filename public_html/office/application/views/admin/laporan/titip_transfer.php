...
<div class="row">
  <div class="box box-primary">
    <div class="box-header with-border">
      <?php if($min==0){ ?>
      <h4 class="pull-left"><b>Total Laba  <?php echo $tanggal_now ." : Rp.".number_format($total_laba) ?></p></b></h4>
      <?php }else if($min!=0){ ?>
      <h4 class="pull-left"><b>Total Laba  &nbsp;</h4> <h4><?php echo $tanggal_now ." : Rp.".number_format($total_laba) ?></b></h4>
      <?php } ?>
      <form method="post" action="<?php echo base_url('admin/laporan/titip_transfer_filter') ?>">
...
<div class="row">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><b>Laporan Transaksi Titip Transfer <?php echo $tanggal_now ?></b></h3>
    </div>
