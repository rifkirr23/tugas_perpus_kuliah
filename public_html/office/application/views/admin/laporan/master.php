        ...
        <table class="table table-striped no-margin" id="myresia">
          <thead>
            ...
            <tr>
              ...
              <td><h4><b><?php echo "Rp.". number_format($total_laba + $total_laba_resi + $total_laba_resi_udara + $total_laba_fcl) ?></b></h4></td>
            <tr>
            <tr>
            ...
            <tr>
              ...
              <td><b><?php echo "Rp.". number_format($data_master->total_laba) ?></b></td>
            </tr>
            <tr>
              <td>Total Semua Asuransi Belum Invoice</td>
              <td><b><?php echo "Rp.". number_format($data_master->total_asuransi) ?></b></td>
            </tr>
            <tr>
              <td>Total Semua Komisi Resi Belum Invoice</td>
              <td><b><?php echo "Rp.". number_format($data_master->total_komisi) ?></b></td>
            </tr>
          </thead>
        </table>
      </div>
