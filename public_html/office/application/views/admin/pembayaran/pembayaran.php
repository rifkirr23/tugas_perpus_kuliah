...
<div class="row">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><b>Pembayaran List</b></h3>
      <span class="pull-right">

                 <a class="btn btn-primary" href="<?php echo site_url() ?>admin/pembayaran/new"><i class="fa fa-plus">Pembayaran</i></a>
    ...
    $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url()?>/admin/pembayaran/get_pembayaran_json", "type": "POST"},
                  columns: [
                        {"data": "kode"},
                        {"data": "kode_cgrup"},
