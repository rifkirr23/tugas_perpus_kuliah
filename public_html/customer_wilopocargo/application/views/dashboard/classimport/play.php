...
<body>
<?php
    $idvideo=$detail->videoId;
    $keterangan=$detail->description;
    $judulnya=$detail->title;
?>
    ...
    <div id="jendelaKonten" class="jendela-konten">
        <div class="jendela-video">
            <div class="wrap-video">
                <iframe src="https://www.youtube.com/embed/<?php echo $idvideo; ?>?controls=0&emb_rel_end=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="overflow-x">
                            ...
                            <?php foreach($lv as $key => $item){  if(isset($item->videoId)){?>
                                <li>
                                    <a class="item-track <?php if($item->videoId == $idvideo){?>active<?php } ?>" href="<?php echo base_url(); ?>classimport/play/<?php echo $item->videoId ;?>">
                                        <div class="inner">
                                            <div class="thumb">
                                                <img src="<?php echo $item->thumbnails; ?>" alt="">
                                            </div>
                                            <div class="desc">
                                            <?php if($item->videoId == $idvideo){ $idsebelumnya=$lv[$key-1]->videoId; $idselanjutnya=$lv[$key+1]->videoId;?>
