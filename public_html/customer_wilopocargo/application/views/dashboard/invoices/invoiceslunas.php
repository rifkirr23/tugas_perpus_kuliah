<head>
  <title>Wilopo Cargo - Invoice Lunas</title>
...
<!--Main Konten-->
        ...
        <div class="container-fluid">
            ...
            <nav class="jumbotron-menu tab-kartu">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link active" href="<?php echo base_url(); ?>invoices/lunas" aria-controls="nav-titip">Sudah Lunas</a>
    ...
    function Datainv() {
            ...
            "language": {
                ...
                processing: true,
                serverSide: true,
                ajax: {"url": "<?php echo base_url('invoices/get_invoicelunas_json')?>", "type": "POST"},
                    columns: [
