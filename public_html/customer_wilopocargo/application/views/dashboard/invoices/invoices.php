<head>
<title>Wilopo Cargo - Invoice</title>
...
<!--Main Konten-->
        ...
        <div class="container-fluid">
            ...
            <nav class="jumbotron-menu tab-kartu">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" href="<?php echo base_url(); ?>invoices" aria-controls="nav-home">Semua Invoice</a>
                    <a class="nav-item nav-link" href="<?php echo base_url(); ?>invoices/lunas" aria-controls="nav-titip">Sudah Lunas</a>
                    <a class="nav-item nav-link" href="<?php echo base_url(); ?>invoices/belumlunas" aria-controls="nav-barang">Belum Lunas</a>
                </div>
            </nav>
    ...
    function Datainv() {
            ...
            "language": {
                ...
                processing: true,
                serverSide: true,
                ajax: {"url": "<?php echo base_url('invoices/get_invoiceid_json')?>", "type": "POST"},
                    columns: [
                            ...
                            render : function(data,type,row){
                                var strStatus = "";
                                if(row.status_invoice == 0 && row.total_tagihan > row.jumlah_bayar && row.jumlah_bayar != 0){
                                    strStatus = "Dibayar Sebagian";
                                }else if(row.status_invoice == 0){
