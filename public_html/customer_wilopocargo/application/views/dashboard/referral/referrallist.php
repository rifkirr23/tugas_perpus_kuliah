        ...
        <div class="top-minus">
            ...
            <nav class="jumbotron-menu tab-kartu">
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link active" href="<?php echo base_url(); ?>referral/referrallist" aria-controls="nav-titip" aria-selected="false">List Referral</a>
                ...
                <div class="col-12">
                    <div>
                        ...
                        <div class="kartu">
                            <div class="head-kartu">
                                <div class="kiri">
                                    <h3><i class="fa fa-money-check"></i> Daftar Customer</h3>
                                </div>
                                <div class="kanan">
                            ...
                            <div class="body-kartu">
                                <table id="listref" class="stripe hover" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th>Kode Marking</th>
                                            <th>Nama</th>
...
<script>
    ...
    $(document).ready(function() {
      // Setup datatables
        ...
        var table = $("#listref").dataTable({
            initComplete: function() {
                var api = this.api();
                $('#listref_filter keyup')
                    .off('.DT')
            ...
            "language": {
                ...
                processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url()?>/referral/get_komisi_referallist_json", "type": "POST"},
                  columns: [
                        {"data": "kode"},
                        {"data": "nama"},
                        {"data": "telepon"},
