...
<div class="row">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title"><b>Invoice Udara</b></h3>
    </div>
  ...
  <form action="<?php echo base_url().'admin/resi_udara/simpan_proses'?>" method="post" id="add-row-form" class="">
  ...
  <form id="add-row-form" action="<?php echo base_url().'admin/resi_udara/simpan_deposit'?>" method="post">
    ...
    $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      ...
      var table = $("#mytable").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url()?>admin/resi_udara/get_invoice_json", "type": "POST"},
                  columns: [
                        {"data": "kode"},
                        {"data": "kode_invoice"},
...
<script type="text/javascript">
  function bayar_deposit(id)
  {
    ...
    $.ajax({
      type : "GET",
      url : "<?php echo base_url() ?>admin/resi_udara/bayar_deposit/"+id,
      cache : false,
      async : false,
